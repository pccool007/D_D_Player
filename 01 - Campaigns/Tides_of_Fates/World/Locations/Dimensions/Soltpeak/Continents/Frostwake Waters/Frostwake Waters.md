...
description: The north-western sea of the Archipelago — frozen, glacial and deadly, claimed by ice. Remote, icebound, and rumored to harbor ancient secrets beneath the glaciers.
word_description:
  - North-West Sea
  - Icebound
population:
...
> [!map] Map
> ```leaflet
> id: Frostwake Waters_map_Leaflet_
...
### Associated Quest
> [!table-data]- Quest's For Frostwake Waters
> ```dataview
...
> and contains(locations,[[Frostwake Waters]])
> SORT file.name ASC
> ```
