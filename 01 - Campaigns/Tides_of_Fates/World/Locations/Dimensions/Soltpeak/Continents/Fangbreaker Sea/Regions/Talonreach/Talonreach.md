...
location_tier_level: 2
description: A colossal island ringed by an ancient plateau that rises like a natural fortress wall above the surrounding seas. The interior basin sits lower than the world's waterline, sealed from rain and moisture by the plateau's shadow. What little water existed dried up long ago. Talonreach is a brutal desert — a land of cracked earth, volcanic sulfur mines, howling dust storms, and warring tribes. Where the rest of Soltpeak follows rivers, Talonreach follows blood.
word_description:
  - Sunken desert
  - Plateau-ringed
  - Warband rule
...
### Associated Quest
> [!table-data]- Quest's For Talonreach
> ```dataview
...
> and contains(locations,[[Talonreach]])
> SORT file.name ASC
> ```
