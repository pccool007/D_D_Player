...
description: The south-western sea of the Archipelago — Talonreach and the untamed wild waters that ring it.
word_description:
  - South-West Sea
  - Untamed Waters
population:
...
> [!map] Map
> ```leaflet
> id: Fangbreaker Sea_map_Leaflet_
...
### Associated Quest
> [!table-data]- Quest's For Fangbreaker Sea
> ```dataview
...
> and contains(locations,[[Fangbreaker Sea]])
> SORT file.name ASC
> ```
