...
description: An isolationist fey nation blanketed by a massive enchanted forest.
word_description:
  - Fey Nation
  - Isolationist
  - Eternal Forest
population:
leader:
theme: Fey forest, nature worship, isolationist
terrain:
govtType:
defences:
imports:
...
### Associated Quest
> [!table-data]- Quest's For Mara Silva
> ```dataview
...
> and contains(locations,[[Mara Silva]])
> SORT file.name ASC
> ```
