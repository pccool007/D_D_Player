...
description: A nation of magitech and machine-craft, and home of the Arcanomatons.
word_description:
  - Magitech Nation
  - The Awakened
  - Federation Shipyard
...
### Associated Quest
> [!table-data]- Quest's For Cognitopia
> ```dataview
...
> and contains(locations,[[Cognitopia]])
> SORT file.name ASC
> ```
