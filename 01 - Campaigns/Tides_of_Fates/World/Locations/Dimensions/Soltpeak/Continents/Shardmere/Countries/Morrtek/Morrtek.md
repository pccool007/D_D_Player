...
description: The nation at the heart of the world's resurrection trade — the one place souls can be reliably called back from death, and the seat of the secretive Black Magus order.
word_description:
  - Resurrection Trade
  - Death-Touched
  - Secretive
...
theme:
terrain:
govtType: Magocracy — ruled by the Black Magus, with vassal noble crowns
defences:
imports:
exports:
urls:
...
### Associated Quest
> [!table-data]- Quest's For Morrtek
> ```dataview
...
> and contains(locations,[[Morrtek]])
> SORT file.name ASC
> ```
