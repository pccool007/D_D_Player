...
description: The north-eastern sea of the Archipelago. The name evokes fractured alliances and magical fallout, and its waters hold the most divided collection of nations in the world.
word_description:
  - North-East Sea
  - Fractured Alliances
population:
...
### Associated Quest
> [!table-data]- Quest's For Shardmere
> ```dataview
...
> and contains(locations,[[Shardmere]])
> SORT file.name ASC
> ```
