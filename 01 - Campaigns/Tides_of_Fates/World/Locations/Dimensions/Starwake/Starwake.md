...
description: The astral and dream plane, the outermost realm that holds all the others within it.
word_description:
  - Astral Plane
  - Dreams
population:
...
### Associated Quest
> [!table-data]- Quest's For Starwake
> ```dataview
...
> and contains(locations,[[Starwake]])
> SORT file.name ASC
> ```
