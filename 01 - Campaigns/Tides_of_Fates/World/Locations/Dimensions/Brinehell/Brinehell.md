...
description: The Hells, where the infernal-claimed are twisted into devils.
word_description:
  - The Hells
  - Infernal
population:
...
### Associated Quest
> [!table-data]- Quest's For Brinehell
> ```dataview
...
> and contains(locations,[[Brinehell]])
> SORT file.name ASC
> ```
