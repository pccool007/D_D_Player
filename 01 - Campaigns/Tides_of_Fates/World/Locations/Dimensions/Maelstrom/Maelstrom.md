...
description: The Abyss — drowning madness, where the ruinous are remade into demons.
word_description:
  - The Abyss
  - Drowning Madness
population:
...
### Associated Quest
> [!table-data]- Quest's For Maelstrom
> ```dataview
...
> and contains(locations,[[Maelstrom]])
> SORT file.name ASC
> ```
