...
description: The deep — the realm of dark water below the open sea, home of the Sunken Court. Among the things lost in its dark is the drowned capital of a fallen crown.
word_description:
  - The Deep
  - Drowned Realm
population:
...
### Associated Quest
> [!table-data]- Quest's For Aquamersi
> ```dataview
...
> and contains(locations,[[Aquamersi]])
> SORT file.name ASC
> ```
