...
description: The elemental plane of Earth, one of the four faces of Prismara.
word_description:
  - Earth
population:
leader: 
...
### Associated Quest
> [!table-data]- Quest's For Terrathis
> ```dataview
...
> and contains(locations,[[Terrathis]])
> SORT file.name ASC
> ```
