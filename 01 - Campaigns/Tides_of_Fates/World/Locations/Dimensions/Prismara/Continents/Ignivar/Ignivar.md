...
description: The elemental plane of Fire, one of the four faces of Prismara.
word_description:
  - Fire
population:
leader: 
...
### Associated Quest
> [!table-data]- Quest's For Ignivar
> ```dataview
...
> and contains(locations,[[Ignivar]])
> SORT file.name ASC
> ```
