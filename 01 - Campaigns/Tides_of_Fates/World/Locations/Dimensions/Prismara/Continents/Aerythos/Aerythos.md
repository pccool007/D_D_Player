...
description: The elemental plane of Air, one of the four faces of Prismara.
word_description:
  - Air
population:
leader: 
...
### Associated Quest
> [!table-data]- Quest's For Aerythos
> ```dataview
...
> and contains(locations,[[Aerythos]])
> SORT file.name ASC
> ```
