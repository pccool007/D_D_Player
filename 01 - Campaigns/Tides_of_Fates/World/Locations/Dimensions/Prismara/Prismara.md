...
description: The elemental plane — Aerythos, Ignivar, Terrathis, and Torrenthal, whose breach drowned the world.
word_description:
  - Elemental Plane
  - The Breach
population:
...
### Associated Quest
> [!table-data]- Quest's For Prismara
> ```dataview
...
> and contains(locations,[[Prismara]])
> SORT file.name ASC
> ```
